...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="blue" data-image="../assets/img/logozapa.png">
            <div class="logo bg-alert"><a href="./" class="simple-text logo-normal">
            IkerSneackers
                </a></div>
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex" href="accesorios.php">
